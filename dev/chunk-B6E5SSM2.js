import{a as P}from"./chunk-KOOIFXDL.js";import{a as Ee,e as Te}from"./chunk-5JM2UCJO.js";import{f as C}from"./chunk-HT4KS53Q.js";import"./chunk-S4BQSA75.js";import{b as ue,c as fe,d as b,e as we,f as _e,g as ye,h as Ce,m as be,o as xe,v as ee,y as ke,z as Re}from"./chunk-M4NKACLP.js";import{A as V,B as z,G as g,J as le,L as a,La as he,Ma as ge,Oa as J,Q as m,R as c,T as d,U as l,Va as ve,W as de,X as h,Xa as pe,a as te,b as ie,ca as ce,db as Se,f as se,h as D,jb as me,k as oe,l as r,ob as v,q as re,t as ne,u as ae,z as K}from"./chunk-MOVX7DVK.js";var Oe=`<div class="awg-edition-svg-sheet-footer mt-4">
...
`;var De="";var u,I=(u=class{constructor(e){this.utils=e,this.navigateToReportFragmentRequest=new a,this.openModalRequest=new a,this.selectSvgSheetRequest=new a,this.faChevronRight=me,this.faChevronDown=Se,this.showTextcritics=!1,this.ref=this}navigateToReportFragment(e){e?.fragmentId&&this.navigateToReportFragmentRequest.emit(e)}openModal(e){e&&this.openModalRequest.emit(e)}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}toggleTextcritics(){this.showTextcritics=!this.showTextcritics}},u.ctorParameters=()=>[{type:C}],u.propDecorators={selectedTextcriticalCommentBlocks:[{type:d}],selectedTextcritics:[{type:d}],showTkA:[{type:d}],navigateToReportFragmentRequest:[{type:l}],openModalRequest:[{type:l}],selectSvgSheetRequest:[{type:l}]},u);I=r([c({selector:"awg-edition-svg-sheet-footer",template:Oe,changeDetection:g.OnPush,styles:[De]})],I);var H=class{};H=r([h({imports:[v,P],declarations:[I],exports:[I]})],H);var Ie=`<h6 class="card-title">
    {{ navItemLabel }}:
...
`;var Le="";var x,q=(x=class{constructor(){this.selectSvgSheetRequest=new a}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}},x.propDecorators={svgSheetsData:[{type:d}],selectedSvgSheet:[{type:d}],selectSvgSheetRequest:[{type:l}]},x);q=r([c({selector:"awg-edition-svg-sheet-nav",template:qe,changeDetection:g.OnPush,styles:[Le]})],q);var W=class{};W=r([h({imports:[v],declarations:[q,A],exports:[q,A]})],W);var Me=`<div class="awg-edition-svg-sheet-viewer-nav">
...
`;var He="";var T,F=(T=class{constructor(){this.openModalRequest=new a,this.selectSvgSheetRequest=new a,this.faSquare=pe,this.folioLegends=[{color:"olivedrab",label:"aktuell ausgew\xE4hlt"},{color:"orange",label:"ausw\xE4hlbar"},{color:"grey",label:"(momentan noch) nicht ausw\xE4hlbar"}]}openModal(e){e&&this.openModalRequest.emit(e)}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}},T.propDecorators={selectedConvolute:[{type:d}],selectedSvgSheet:[{type:d}],openModalRequest:[{type:l}],selectSvgSheetRequest:[{type:l}]},T);F=r([c({selector:"awg-edition-convolute",template:Pe,changeDetection:g.OnPush,styles:[He]})],F);var We=`<!-- embedded svg: Edition Folio Viewer -->
...
`;var Ze="";var y,$=(y=class{constructor(e,t,i,s,o,n){this.editionDataService=e,this.editionSheetsService=t,this.editionService=i,this.utils=s,this.route=o,this.router=n,this.errorObject=null,this.isLoading=!0,this.showTkA=!1,this._destroyed$=new D,this._isFirstPageLoad=!0}get editionRouteConstants(){return ue}ngOnInit(){this.getEditionSheetsData()}getEditionSheetsData(){this.errorObject=null,this.snapshotQueryParamsId=this.route.snapshot.queryParamMap.get("id"),re([this.route.paramMap,this.route.queryParamMap]).pipe(K(([e,t])=>this._fetchEditionComplexData(t)),ne(e=>(this.errorObject=e,this.isLoading=!1,oe)),V(this._destroyed$)).subscribe({next:()=>{this.isLoading=!1},error:e=>{this.errorObject=e,this.isLoading=!1}})}onLinkBoxSelect(e){if(!this.selectedSvgSheet||!this.selectedTextcritics?.linkBoxes)return;let t=this.selectedTextcritics.linkBoxes.find(i=>i.svgGroupId===e);if(t){let i=t.linkTo;this.onSvgSheetSelect(i)}}onReportFragmentNavigate(e){let t=this.editionRouteConstants.EDITION_REPORT.route,i={fragment:e?.fragmentId??""};this._navigateWithComplexId(e?.complexId,t,i)}onOverlaySelect(e){this.selectedTextcriticalCommentBlocks=this.editionSheetsService.getTextcriticalCommentsForOverlays(this.selectedTextcritics.comments,e),this.showTkA=this.utils.isNotEmptyArray(this.selectedTextcriticalCommentBlocks)}onBrowseSvgSheet(e){let t=this.editionSheetsService.getCurrentEditionType(this.selectedSvgSheet,this.svgSheetsData.sheets);if(!t)return;let i=this.svgSheetsData.sheets[t],s=this.editionSheetsService.getNextSheetId(e,this.selectedSvgSheet,i);this.onSvgSheetSelect({complexId:"",sheetId:s})}onSvgSheetSelect(e){let t=this.editionRouteConstants.EDITION_SHEETS.route,i={queryParams:{id:e?.sheetId??""},queryParamsHandling:"merge"};this._navigateWithComplexId(e?.complexId,t,i)}ngOnDestroy(){this._destroyed$.next(!0),this._destroyed$.complete()}_assignData(e){this.folioConvoluteData=e[0],this.svgSheetsData=e[1],this.textcriticsData=e[2]}_fetchEditionComplexData(e){return this.isLoading=!0,this.editionService.getSelectedEditionComplex().pipe(z(t=>this.editionComplex=t),K(t=>this.editionDataService.getEditionSheetsData(t)),z(t=>this._assignData(t)),z(()=>this._handleQueryParams(e)))}_getDefaultSheetId(){let e=this.svgSheetsData?.sheets?.sketchEditions?.[0],t=e?.content?.length>1?e.content[0]?.partial:"";return(e?.id||"")+t}_handleQueryParams(e){let t=e?.get("id");t&&this.svgSheetsData?this._selectSvgSheet(t):(t=this._isFirstPageLoad&&this.snapshotQueryParamsId?this.snapshotQueryParamsId:this._getDefaultSheetId(),t===""&&(this.selectedSvgSheet=void 0),this.onSvgSheetSelect({complexId:"",sheetId:t})),this._isFirstPageLoad=!1,this.isLoading=!1}_navigateWithComplexId(e,t,i){let s=e?`/edition/complex/${e}/`:this.editionComplex.baseRoute;this.router.navigate([s,t],i)}_selectSvgSheet(e){e&&(this.selectedSvgSheet=this.editionSheetsService.selectSvgSheetById(this.svgSheetsData.sheets,e),this.selectedConvolute=this.editionSheetsService.selectConvolute(this.folioConvoluteData.convolutes,this.svgSheetsData.sheets,this.selectedSvgSheet),this.selectedTextcritics=this.editionSheetsService.findTextcritics(this.textcriticsData.textcritics,this.selectedSvgSheet),this.onOverlaySelect([]),this.utils.isNotEmptyObject(this.selectedTextcritics)&&this.utils.isNotEmptyArray(this.selectedTextcritics.comments)&&(this.selectedTextcriticalCommentBlocks=this.selectedTextcritics.comments))}},y.ctorParameters=()=>[{type:be},{type:xe},{type:Re},{type:C},{type:he},{type:ge}],y.propDecorators={modal:[{type:m,args:["modal",{static:!0}]}]},y);$=r([c({selector:"awg-edition-sheets",template:je,styles:[Ze]})],$);var ut=[{path:"",component:$,data:{title:"AWG Online Edition \u2013 Sheets"}}],Ye=[$],Q=class{};Q=r([h({imports:[J.forChild(ut)],exports:[J]})],Q);var Xe=class{};Xe=r([h({imports:[v,j,X,Q],declarations:[Ye]})],Xe);export{Xe as EditionSheetsModule};
