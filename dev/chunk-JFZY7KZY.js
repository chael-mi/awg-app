import{a as P}from"./chunk-I7IXUIMH.js";import{a as ke,e as Re}from"./chunk-TUG4I2IT.js";import{f as C}from"./chunk-FNACZB34.js";import{a as ye,b as Ce,i as ee,l as be,m as xe}from"./chunk-FEI7N5PX.js";import{c as Se,e as me,f as b,g as ue,j as fe,k as we,t as _e}from"./chunk-XDTQHBQK.js";import"./chunk-DVBDYUR7.js";import{A as V,B as z,G as g,J as ne,L as a,La as de,Ma as ce,Oa as J,Q as m,R as c,T as d,U as l,Va as he,W as ae,X as h,Xa as ge,a as te,b as ie,ca as le,db as ve,f as se,h as D,jb as pe,l as r,ob as v,q as oe,u as re,z as K}from"./chunk-EOZI3YUX.js";var Ee=`<div class="awg-edition-svg-sheet-footer mt-4">
...
`;var Te="";var u,A=(u=class{constructor(e){this.utils=e,this.navigateToReportFragmentRequest=new a,this.openModalRequest=new a,this.selectSvgSheetRequest=new a,this.faChevronRight=pe,this.faChevronDown=ve,this.showTextcritics=!1,this.ref=this}navigateToReportFragment(e){e&&this.navigateToReportFragmentRequest.emit(e)}openModal(e){e&&this.openModalRequest.emit(e)}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}toggleTextcritics(){this.showTextcritics=!this.showTextcritics}},u.ctorParameters=()=>[{type:C}],u.propDecorators={selectedTextcriticalComments:[{type:d}],selectedTextcritics:[{type:d}],showTkA:[{type:d}],navigateToReportFragmentRequest:[{type:l}],openModalRequest:[{type:l}],selectSvgSheetRequest:[{type:l}]},u);A=r([c({selector:"awg-edition-svg-sheet-footer",template:Ee,changeDetection:g.OnPush,styles:[Te]})],A);var H=class{};H=r([h({imports:[v,P],declarations:[A],exports:[A]})],H);var Oe=`<h6 class="card-title">
    {{ navItemLabel }}:
...
`;var f,I=(f=class{constructor(e){this.utils=e,this.selectSvgSheetRequest=new a}isSelectedSvgSheet(e,t){let i=e,s=this.selectedSvgSheet.id;return t&&this.selectedSvgSheet.content?.[0]?.partial&&(i+=t,s+=this.selectedSvgSheet.content[0].partial),i===s}selectSvgSheet(e,t){t&&this.selectSvgSheetRequest.emit({complexId:e,sheetId:t})}},f.ctorParameters=()=>[{type:C}],f.propDecorators={navItemLabel:[{type:d}],svgSheets:[{type:d}],selectedSvgSheet:[{type:d}],selectSvgSheetRequest:[{type:l}]},f);I=r([c({selector:"awg-edition-svg-sheet-nav-item",template:Oe,styles:[De]})],I);var Ae=`@if (svgSheetsData) {
...
`;var Ie="";var x,q=(x=class{constructor(){this.selectSvgSheetRequest=new a}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}},x.propDecorators={svgSheetsData:[{type:d}],selectedSvgSheet:[{type:d}],selectSvgSheetRequest:[{type:l}]},x);q=r([c({selector:"awg-edition-svg-sheet-nav",template:Ae,changeDetection:g.OnPush,styles:[Ie]})],q);var W=class{};W=r([h({imports:[v],declarations:[q,I],exports:[q,I]})],W);var qe=`<div class="awg-edition-svg-sheet-viewer-nav">
...
`;var $e="";var E,F=(E=class{constructor(){this.browseSvgSheetRequest=new a,this.navigateToReportFragmentRequest=new a,this.openModalRequest=new a,this.selectLinkBoxRequest=new a,this.selectOverlaysRequest=new a,this.selectSvgSheetRequest=new a}browseSvgSheet(e){e&&this.browseSvgSheetRequest.emit(e)}navigateToReportFragment(e){e&&this.navigateToReportFragmentRequest.emit(e)}openModal(e){e&&this.openModalRequest.emit(e)}selectLinkBox(e){this.selectLinkBoxRequest.emit(e)}selectOverlays(e){this.selectOverlaysRequest.emit(e)}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}},E.propDecorators={svgSheetsData:[{type:d}],selectedSvgSheet:[{type:d}],selectedTextcriticalComments:[{type:d}],selectedTextcritics:[{type:d}],showTkA:[{type:d}],browseSvgSheetRequest:[{type:l}],navigateToReportFragmentRequest:[{type:l}],openModalRequest:[{type:l}],selectLinkBoxRequest:[{type:l}],selectOverlaysRequest:[{type:l}],selectSvgSheetRequest:[{type:l}]},E);F=r([c({selector:"awg-edition-accolade",template:Be,changeDetection:g.OnPush,styles:[$e]})],F);var Z=class{};Z=r([h({imports:[v,H,W,U],declarations:[F],exports:[F]})],Z);var Ve=`<div ngbAccordion>
...
`;var ze="";var T,N=(T=class{constructor(){this.openModalRequest=new a,this.selectSvgSheetRequest=new a,this.faSquare=ge,this.folioLegends=[{color:"olivedrab",label:"aktuell ausgew\xE4hlt"},{color:"orange",label:"ausw\xE4hlbar"},{color:"grey",label:"(momentan noch) nicht ausw\xE4hlbar"}]}openModal(e){e&&this.openModalRequest.emit(e)}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}},T.propDecorators={selectedConvolute:[{type:d}],selectedSvgSheet:[{type:d}],openModalRequest:[{type:l}],selectSvgSheetRequest:[{type:l}]},T);N=r([c({selector:"awg-edition-convolute",template:Ve,changeDetection:g.OnPush,styles:[ze]})],N);var Pe=`<!-- embedded svg: Edition Folio Viewer -->
...
`;var Ue="";var y,$=(y=class{constructor(e,t,i,s,o,n){this.editionDataService=e,this.editionSheetsService=t,this.editionService=i,this.utils=s,this.route=o,this.router=n,this.errorMessage=void 0,this.showTkA=!1,this._destroyed$=new D,this._isFirstPageLoad=!0}get editionRouteConstants(){return Se}ngOnInit(){this.getEditionSheetsData()}getEditionSheetsData(){this.snapshotQueryParamsId=this.route.snapshot.queryParamMap.get("id"),oe([this.route.paramMap,this.route.queryParamMap]).pipe(K(([e,t])=>this._fetchEditionComplexData(t)),V(this._destroyed$)).subscribe({next:()=>{},error:e=>{console.error(e),this.errorMessage=e}})}onLinkBoxSelect(e){if(!this.selectedSvgSheet||!this.selectedTextcritics?.linkBoxes)return;let t=this.selectedTextcritics.linkBoxes.find(i=>i.svgGroupId===e);if(t){let i=t.linkTo;this.onSvgSheetSelect(i)}}onNavigateToReportFragment(e){e||(e="");let t={fragment:e};this.router.navigate([this.editionComplex.baseRoute,this.editionRouteConstants.EDITION_REPORT.route],t)}onOverlaySelect(e){this.selectedTextcriticalComments=this.editionSheetsService.getTextcriticalCommentsForOverlays(this.selectedTextcritics.comments,e),this.showTkA=this.utils.isNotEmptyArray(this.selectedTextcriticalComments)}onBrowseSvgSheet(e){let t=this.editionSheetsService.getCurrentEditionType(this.selectedSvgSheet,this.svgSheetsData.sheets);if(!t)return;let i=this.svgSheetsData.sheets[t],s=this.editionSheetsService.getNextSheetId(e,this.selectedSvgSheet,i);this.onSvgSheetSelect({complexId:"",sheetId:s})}onSvgSheetSelect(e){let t=e.complexId?`/edition/complex/${e.complexId}/`:this.editionComplex.baseRoute,i={queryParams:{id:e.sheetId},queryParamsHandling:"merge"};this.router.navigate([t,this.editionRouteConstants.EDITION_SHEETS.route],i)}ngOnDestroy(){this._destroyed$.next(!0),this._destroyed$.complete()}_assignData(e){this.folioConvoluteData=e[0],this.svgSheetsData=e[1],this.textcriticsData=e[2]}_fetchEditionComplexData(e){return this.editionService.getEditionComplex().pipe(z(t=>this.editionComplex=t),K(t=>this.editionDataService.getEditionSheetsData(t)),z(t=>this._assignData(t)),z(()=>this._handleQueryParams(e)))}_getDefaultSheetId(){let e=this.svgSheetsData?.sheets?.sketchEditions?.[0],t=e?.content?.length>1?e.content[0]?.partial:"";return(e?.id||"")+t}_handleQueryParams(e){let t=e?.get("id");t&&this.svgSheetsData?this._selectSvgSheet(t):(t=this._isFirstPageLoad&&this.snapshotQueryParamsId?this.snapshotQueryParamsId:this._getDefaultSheetId(),this.onSvgSheetSelect({complexId:"",sheetId:t})),this._isFirstPageLoad=!1}_selectSvgSheet(e){e&&(this.selectedSvgSheet=this.editionSheetsService.selectSvgSheetById(this.svgSheetsData.sheets,e),this.selectedConvolute=this.editionSheetsService.selectConvolute(this.folioConvoluteData.convolutes,this.svgSheetsData.sheets,this.selectedSvgSheet),this.selectedTextcritics=this.editionSheetsService.findTextcritics(this.textcriticsData.textcritics,this.selectedSvgSheet),this.onOverlaySelect([]),this.utils.isNotEmptyObject(this.selectedTextcritics)&&this.utils.isNotEmptyArray(this.selectedTextcritics.comments)&&(this.selectedTextcriticalComments=this.selectedTextcritics.comments))}},y.ctorParameters=()=>[{type:ye},{type:Ce},{type:xe},{type:C},{type:de},{type:ce}],y.propDecorators={modal:[{type:m,args:["modal",{static:!0}]}]},y);$=r([c({selector:"awg-edition-sheets",template:We,styles:[Ue]})],$);var St=[{path:"",component:$,data:{title:"AWG Online Edition \u2013 Sheets"}}],Ze=[$],Q=class{};Q=r([h({imports:[J.forChild(St)],exports:[J]})],Q);var Ye=class{};Ye=r([h({imports:[v,Z,j,Q],declarations:[Ze]})],Ye);export{Ye as EditionSheetsModule};
