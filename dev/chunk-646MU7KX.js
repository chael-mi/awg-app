import{a as C}from"./chunk-PP6HJ337.js";import{f as M,u as A}from"./chunk-LUT23FXU.js";import{p as s}from"./chunk-LCM5XYVU.js";import{b as r}from"./chunk-UW47QA52.js";import"./chunk-YSE6EUBO.js";import{A as y,G as N,La as a,Ma as G,Oa as j,R as i,T as _,X as L,h as O,k as $,l as e,ob as P,s as U,x as l}from"./chunk-I7PFRKPI.js";var B=`<!--
...
<router-outlet />
`;var J="";var m,v=(m=class{constructor(t){this.editionService=t,this._destroyed$=new O}ngOnInit(){this.getEditionComplex()}getEditionComplex(){this.editionService.getSelectedEditionComplex().pipe(y(this._destroyed$)).subscribe({next:t=>{this.editionComplex=t,this.setButtons()}})}setButtons(){this.editionRouterLinkButtons=[new C(this.editionComplex.baseRoute,r.EDITION_INTRO.route,r.EDITION_INTRO.short,!1),new C(this.editionComplex.baseRoute,r.EDITION_SHEETS.route,r.EDITION_SHEETS.short,!1),new C(this.editionComplex.baseRoute,r.EDITION_REPORT.route,r.EDITION_REPORT.short,!1),new C(this.editionComplex.baseRoute,r.EDITION_GRAPH.route,r.EDITION_GRAPH.short,!1)]}ngOnDestroy(){this._destroyed$.next(!0),this._destroyed$.complete()}},m.ctorParameters=()=>[{type:s}],m);v=e([i({selector:"awg-edition-detail-nav",template:H,styles:[J]})],v);var z=`@if (editionOutline) {
...
`;var W="";var p,R=(p=class{constructor(t){this.editionService=t}ngOnInit(){this.clearSelections(),this.getEditionOutline()}clearSelections(){this.editionService.clearSelectedEditionSeries(),this.editionService.clearSelectedEditionSection()}getEditionOutline(){this.editionOutline=this.editionService.getEditionOutline()}},p.ctorParameters=()=>[{type:s}],p);R=e([i({selector:"awg-edition-series",template:z,styles:[W]})],R);var q=`<router-outlet />
`;var Y="";var u,b=(u=class{constructor(t,o){this.route=t,this.editionService=o}ngOnInit(){this.updateSeriesFromRoute()}updateSeriesFromRoute(){let t=this.route.snapshot.paramMap.get("id");this.selectedSeries=this.editionService.getEditionSeriesById(t),this.editionService.updateSelectedEditionSeries(this.selectedSeries)}},u.ctorParameters=()=>[{type:a},{type:s}],u);b=e([i({selector:"awg-edition-series-detail",template:q,styles:[Y]})],b);var Z=`@if (
    selectedSection &&
...
`;var te="";var S,T=(S=class{constructor(t,o){this.editionService=t,this.router=o,this.editionViewTitle="Inhalt",this.editionViewId="awg-edition-view"}get editionRouteConstants(){return r}ngOnInit(){this.setupEditionView(),this.routeToSidenav()}setupEditionView(){this.selectedEditionSeries$=this.editionService.getSelectedEditionSeries().pipe(l(0)),this.selectedEditionSection$=this.editionService.getSelectedEditionSection().pipe(l(0)),this.selectedEditionComplex$=this.editionService.getSelectedEditionComplex().pipe(l(0)),this.isPrefaceView$=this.editionService.getIsPrefaceView().pipe(l(0)),this.isRowTableView$=this.editionService.getIsRowTableView().pipe(l(0))}routeToSidenav(){this.router.navigate([{outlets:{side:"editionInfo"}}],{preserveFragment:!0})}},S.ctorParameters=()=>[{type:s},{type:G}],S);T=e([i({selector:"awg-edition-view",template:ee,styles:[te]})],T);var ve=[{path:"",component:T,children:[{path:"series",component:R},{path:"series/:id",component:b,children:[{path:"sections",component:w},{path:"section/:id",component:I},{path:"sections/:id",redirectTo:"section/:id",pathMatch:"full"},{path:"",redirectTo:"sections",pathMatch:"full"}]},{path:"composition",redirectTo:"complex",pathMatch:"prefix"},{path:"complex/:complexId",component:x,children:[{path:"",component:v,children:[{path:"intro",loadChildren:()=>import("./chunk-QKHNG2X6.js").then(n=>n.EditionIntroModule)},{path:"sheets",loadChildren:()=>import("./chunk-OFP4Z77G.js").then(n=>n.EditionSheetsModule)},{path:"report",loadChildren:()=>import("./chunk-JWAPKP43.js").then(n=>n.EditionReportModule)},{path:"graph",loadChildren:()=>import("./chunk-NMGWC6A4.js").then(n=>n.EditionGraphModule)},{path:"",redirectTo:"sheets",pathMatch:"full"}]}]},{path:"preface",loadChildren:()=>import("./chunk-HWN3T2GJ.js").then(n=>n.EditionPrefaceModule)},{path:"row-tables",loadChildren:()=>import("./chunk-4OMZQAZR.js").then(n=>n.EditionRowTablesModule)}]}],ie=[T,x,v,w,I,R,b],D=class{};D=e([L({imports:[j.forChild(ve)],exports:[j]})],D);var oe=`<div class="row row-cols-1 row-cols-md-3 row-cols-xl-5 g-4">
...
`;var se="";var f,k=(f=class{},f.propDecorators={complexes:[{type:_}]},f);k=e([i({selector:"awg-edition-complex-card",template:oe,changeDetection:N.OnPush,styles:[se]})],k);var ne=`<div
...
`;var re="";var g,V=(g=class{},g.propDecorators={jumbotronId:[{type:_}],jumbotronTitle:[{type:_}]},g);V=e([i({selector:"awg-edition-jumbotron",template:ne,changeDetection:N.OnPush,styles:[re]})],V);var de=class{};de=e([L({imports:[P,D],declarations:[ie,k,V]})],de);export{de as EditionViewModule};
