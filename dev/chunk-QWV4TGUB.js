import{b as o,s as c}from"./chunk-HT4KS53Q.js";import"./chunk-S4BQSA75.js";import"./chunk-M4NKACLP.js";import{G as s,Ma as g,Oa as r,R as d,X as a,l as e,ob as l}from"./chunk-MOVX7DVK.js";var u=`<!-- content: contact -->
...
<div id="awg-disclaimer">
    ...
    <p>
        ...
        Gesamtausgabe) f\xFCr den Nutzer zug\xE4nglich sind, sind urheberrechtlich gesch\xFCtzt und werden \u2013 sofern nicht anders
    ...
    <p>
        ...
        der {{ pageMetaData.awgProjectName }}) aus verlinkten externen Internetseiten. Eine Pr\xFCfung bei der Verlinkung
        ergab keine strafbaren Inhalte auf diesen Seiten. Alle Linkangaben sind ohne Gew\xE4hr. Seitenaufrufe externer
        Seiten \xFCber diese Links erfolgen auf eigene Gefahr. Dies gilt f\xFCr alle Links auf der Website und der
...
`;var p="";var t,n=(t=class{constructor(f,w){this.coreService=f,this.router=w,this.imprintTitle="Impressum",this.imprintId="awg-imprint",this.citationTitle="Zitation",this.citationId="awg-citation",this.documentationTitle="Dokumentation",this.documentationId="awg-documentation",this.dateFormat="d. MMMM yyyy"}ngOnInit(){this.routeToSidenav(),this.provideMetaData(),this.today=Date.now()}provideMetaData(){this.pageMetaData=this.coreService.getMetaDataSection(o.page),this.contactMetaData=this.coreService.getMetaDataSection(o.contact)}routeToSidenav(){this.router.navigate([{outlets:{side:"contactInfo"}}],{preserveFragment:!0,queryParamsHandling:"preserve"})}},t.ctorParameters=()=>[{type:c},{type:g}],t);n=e([d({selector:"awg-contact-view",template:u,changeDetection:s.OnPush,styles:[p]})],n);var z=[{path:"",component:n,data:{title:"AWG Online Edition \u2013 Contact"}}],h=[n],i=class{};i=e([a({imports:[r.forChild(z)],exports:[r]})],i);var m=class{};m=e([a({imports:[l,i],declarations:[h]})],m);export{m as ContactViewModule};
