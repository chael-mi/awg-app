import{a as x}from"./chunk-3XLA4IRK.js";import{f as p}from"./chunk-A2PVE34K.js";import{a as G,m as W}from"./chunk-T47KO64K.js";import{c as D,v as L}from"./chunk-CQGKILLD.js";import"./chunk-R63KHA52.js";import{G as r,L as i,Ma as A,Oa as k,Q as F,R as n,T as c,U as o,X as v,k as q,l as s,ob as b,t as O,z as N}from"./chunk-HWHDN4RD.js";var U=`<div class="awg-source-description-corrections">
...
`;var P="";var m,T=(m=class{constructor(){this.navigateToReportFragmentRequest=new i,this.openModalRequest=new i,this.selectSvgSheetRequest=new i,this.ref=this}navigateToReportFragment(t){t&&this.navigateToReportFragmentRequest.emit(t)}openModal(t){t&&this.openModalRequest.emit(t)}selectSvgSheet(t){t?.sheetId&&this.selectSvgSheetRequest.emit(t)}},m.ctorParameters=()=>[],m.propDecorators={corrections:[{type:c}],navigateToReportFragmentRequest:[{type:o}],openModalRequest:[{type:o}],selectSvgSheetRequest:[{type:o}]},m);T=s([n({selector:"awg-source-description-corrections",template:U,changeDetection:r.OnPush,styles:[P]})],T);var j=`@if (sourceDescriptionListData) {
...
`;var B="";var u,S=(u=class{constructor(t){this.utils=t,this.navigateToReportFragmentRequest=new i,this.openModalRequest=new i,this.selectSvgSheetRequest=new i,this.FIRM_SIGNS=L,this.ref=this}getWritingInstruments(t){let e=t.secondary?.join(", ");return`${e?`${t.main}; ${e}`:t.main}.`}getWritingMaterialFirmSign(t){return t&&this.FIRM_SIGNS[t]?this.FIRM_SIGNS[t]:{route:"",full:"Not a known firm sign.",short:"unknown"}}getWritingMaterialItemLocation(t){if(!this.utils.isNotEmptyObject(t)||!this.utils.isNotEmptyArray(t.folios))return"";let e=t.folios.map(a=>a.endsWith("v")||a.endsWith("r")?`${a.slice(0,-1)}<sup>${a.slice(-1)}</sup>`:a),l=e.length>1?`${e.slice(0,-1).join(", ")} und ${e.slice(-1)}`:e[0],y=t.info?`${t.info} `:"",R=t.position?` ${t.position}`:"";return`${y}auf Bl. ${l}${R}`}getWritingMaterialFormat(t){let{orientation:e,height:l,width:y}=t,R=a=>this.utils.isNotEmptyObject(a)?a.uncertainty?`${a.uncertainty} ${a.value}`:a.value:"";return`Format: ${e} ${R(l)} \xD7 ${R(y)} mm`}getWritingMaterialSystems(t){return[`${t.number} ${t.number===1?"System":"Systeme"}`,t.info&&` (${t.info})`,t.addendum&&`, ${t.addendum}`].filter(Boolean).join("")}navigateToReportFragment(t){t&&this.navigateToReportFragmentRequest.emit(t)}openModal(t){t&&this.openModalRequest.emit(t)}selectSvgSheet(t){t?.sheetId&&this.selectSvgSheetRequest.emit(t)}},u.ctorParameters=()=>[{type:p}],u.propDecorators={sourceDescriptionListData:[{type:c}],navigateToReportFragmentRequest:[{type:o}],openModalRequest:[{type:o}],selectSvgSheetRequest:[{type:o}]},u);S=s([n({selector:"awg-source-description",template:j,changeDetection:r.OnPush,styles:[B]})],S);var M=class{};M=s([v({imports:[b,x],declarations:[S,T],exports:[S]})],M);var H=`@if (sourceEvaluationListData) {
...
`;var V="";var f,I=(f=class{constructor(t){this.utils=t,this.navigateToReportFragmentRequest=new i,this.openModalRequest=new i,this.selectSvgSheetRequest=new i,this.ref=this}navigateToReportFragment(t){t&&this.navigateToReportFragmentRequest.emit(t)}openModal(t){t&&this.openModalRequest.emit(t)}selectSvgSheet(t){t?.sheetId&&this.selectSvgSheetRequest.emit(t)}},f.ctorParameters=()=>[{type:p}],f.propDecorators={textcriticsData:[{type:c}],navigateToReportFragmentRequest:[{type:o}],openModalRequest:[{type:o}],selectSvgSheetRequest:[{type:o}]},f);I=s([n({selector:"awg-textcritics-list",template:K,changeDetection:r.OnPush,styles:[V]})],I);var Y=`<!-- content: edition report -->
<div>
    <!-- modal -->
...
`;var J="";var h,w=(h=class{constructor(t,e,l){this.editionDataService=t,this.editionService=e,this.router=l,this.errorObject=null,this.titles={sourceList:"1. Quellen\xFCbersicht",sourceDescription:"2. Quellenbeschreibung",sourceEvaluation:"3. Quellenbewertung",tka:"4. Textkritische Anmerkungen"}}get editionRouteConstants(){return D}ngOnInit(){this.getEditionReportData()}getEditionReportData(){this.editionReportData$=this.editionService.getEditionComplex().pipe(N(t=>(this.editionComplex=t,this.editionDataService.getEditionReportData(this.editionComplex))),O(t=>(this.errorObject=t,q)))}onModalOpen(t){t&&this.modal.open(t)}onReportFragmentNavigate(t){t||(t="");let e={fragment:t};this.router.navigate([this.editionComplex.baseRoute,this.editionRouteConstants.EDITION_REPORT.route],e)}onSvgSheetSelect(t){let e=t?.complexId?`/edition/complex/${t?.complexId}/`:this.editionComplex.baseRoute,y={queryParams:{id:t?.sheetId??""}};this.router.navigate([e,this.editionRouteConstants.EDITION_SHEETS.route],y)}},h.ctorParameters=()=>[{type:G},{type:W},{type:A}],h.propDecorators={modal:[{type:F,args:["modal",{static:!0}]}]},h);w=s([n({selector:"awg-edition-report",template:Y,changeDetection:r.OnPush,styles:[J]})],w);var dt=[{path:"",component:w,data:{title:"AWG Online Edition \u2013 Report"}}],X=[w],C=class{};C=s([v({imports:[k.forChild(dt)],exports:[k]})],C);var tt=class{};tt=s([v({imports:[b,x,M,C],declarations:[I,E,_,X]})],tt);export{tt as EditionReportModule};
