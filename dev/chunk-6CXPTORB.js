import{a as Z}from"./chunk-PP6HJ337.js";import{a as m,b as Ne}from"./chunk-MSTPLEVO.js";import{B as Ke,C as _e,e as ye,g as X,h as be,i as A,j as we,k as y,l as ze,m as d,n as b,o as K,p as Oe,q as p,r as L,t as O,u as ke,v as qe,w as Xe,y as Se}from"./chunk-FNACZB34.js";import"./chunk-DVBDYUR7.js";import{A as h,G as i,Ha as S,Ia as me,J as ue,Ka as ge,L as l,La as D,Ma as _,Oa as De,Qa as Qe,R as s,T as n,Ta as Ae,U as c,Wa as Ye,X as P,Za as We,a as Me,cb as fe,fb as Le,gb as Je,h as g,k as Ue,l as o,n as Pe,oa as v,ob as ve,p as f,r as $e,ra as de,s as E,u as Be,v as z,y as He,z as he}from"./chunk-EOZI3YUX.js";var Ze=`<!-- resource detail header -->
...
`;var k,ee=(k=class{constructor(){this.resourceRequest=new l}navigateToResource(e){e&&(e=e.toString(),this.resourceRequest.emit(e))}},k.propDecorators={header:[{type:n}],resourceUrl:[{type:n}],resourceRequest:[{type:c}]},k);ee=o([s({selector:"awg-resource-detail-header",template:Ze,changeDetection:i.OnPush,styles:[et]})],ee);var tt=`<!-- resourceDetailData content -->
...
`;var rt="";var q,te=(q=class{constructor(){this.gndRequest=new l,this.resourceRequest=new l}exposeGnd(e){e?.type&&this.gndRequest.emit(e)}navigateToResource(e){e&&(e=e.toString(),this.resourceRequest.emit(e))}},q.propDecorators={resourceDetailData:[{type:n}],gndRequest:[{type:c}],resourceRequest:[{type:c}]},q);te=o([s({selector:"awg-resource-detail-html",template:tt,changeDetection:i.OnPush,styles:[rt]})],te);var ot=`<!--
/************************************************
*
*               CREDITS
*
...
`;var st="";var N,re=(N=class{constructor(){this.gndRequest=new l,this.resourceRequest=new l}exposeGnd(e){e?.type&&this.gndRequest.emit(e)}navigateToResource(e){e&&(e=e.toString(),this.resourceRequest.emit(e))}},N.propDecorators={content:[{type:n}],gndRequest:[{type:c}],resourceRequest:[{type:c}]},N);re=o([s({selector:"awg-resource-detail-html-content",template:ot,changeDetection:i.OnPush,styles:[st]})],re);var at=`<!--
/************************************************
*
*               CREDITS
*
...
`;var j,oe=(j=class{constructor(){this.galleryOptions=[new Qe({width:"100%",imageSize:"contain",thumbnailSize:"contain",thumbnailMargin:5,thumbnailsMargin:0,previewCloseOnClick:!0,previewCloseOnEsc:!0,previewZoom:!0,previewRotate:!0,linkTarget:"_blank"})]}},j.propDecorators={images:[{type:n}]},j);oe=o([s({selector:"awg-resource-detail-html-content-imageobjects",template:at,changeDetection:i.OnPush,styles:[it]})],oe);var nt=`<!--
/************************************************
*
*               CREDITS
*
...
`;var V,se=(V=class{constructor(){this.resourceRequest=new l}get totalNumber(){return this._getNestedArraysTotalItems(this.incomingGroups)||0}navigateToResource(e){e&&(e=e.toString(),this.resourceRequest.emit(e))}_getNestedArraysTotalItems(e){if(!e)return;let t=(r,a)=>r+a;return e.map(r=>r.links.length).reduce(t,0)}},V.propDecorators={incomingGroups:[{type:n}],resourceRequest:[{type:c}]},V);se=o([s({selector:"awg-resource-detail-html-content-linkedobjects",template:nt,changeDetection:i.OnPush,styles:[lt]})],se);var ct=`<!-- resource detail data content: props -->
...
`;var G,ae=(G=class{constructor(){this.gndRequest=new l,this.resourceRequest=new l,this.metaBreakLine="Versionsdatum"}ngOnChanges(e){e.props&&this._checkForGND(e.props)}exposeGnd(e){e?.type&&this.gndRequest.emit(e)}navigateToResource(e){e&&(e=e.toString(),this.resourceRequest.emit(e))}ngOnDestroy(){this._removeGnd()}_checkForGND(e){let t=e.currentValue.filter(r=>r.pid==="856"&&r.values&&r.values.length>0);this._removeGnd(),t.length>0&&t.forEach(r=>{r.values.forEach(a=>{this._setGnd(a)})})}_setGnd(e){let t=new qe(ke.SET,e);this.exposeGnd(t)}_removeGnd(){let e=new qe(ke.REMOVE,null);this.exposeGnd(e)}},G.propDecorators={props:[{type:n}],gndRequest:[{type:c}],resourceRequest:[{type:c}]},G);ae=o([s({selector:"awg-resource-detail-html-content-props",template:ct,changeDetection:i.OnPush,styles:[pt]})],ae);var ht=`<awg-json-viewer
    jsonViewerHeader="Converted JSON response from Salsah-API"
    [jsonViewerData]="resourceJsonConvertedData">
</awg-json-viewer>
`;var ut="";var F,ie=(F=class{},F.propDecorators={resourceJsonConvertedData:[{type:n}]},F);ie=o([s({selector:"awg-resource-detail-json-converted",template:ht,changeDetection:i.OnPush,styles:[ut]})],ie);var dt=`<awg-json-viewer jsonViewerHeader="Raw JSON response from Salsah-API" [jsonViewerData]="resourceJsonRawData">
</awg-json-viewer>
`;var mt="";var M,ne=(M=class{},M.propDecorators={resourceJsonRawData:[{type:n}]},M);ne=o([s({selector:"awg-resource-detail-json-raw",template:dt,changeDetection:i.OnPush,styles:[mt]})],ne);var Re=class{};Re=o([P({imports:[ve],declarations:[ee,te,re,oe,se,ae,ie,ne],exports:[ee,te,re,oe,se,ae,ie,ne]})],Re);var gt=`@if (extendedSearchForm) {
...
`;var H,R=(H=class{constructor(e,t,r,a,u,J){this.route=e,this.router=t,this.dataApiService=r,this.dataStreamerService=a,this.gndService=u,this.loadingService=J,this.errorMessage=void 0,this.resourceDetailTabTitles={html:"Detail",raw:"JSON (raw)",converted:"JSON (converted)"},this._destroyed$=new g}get httpGetUrl(){return this.dataApiService.httpGetUrl}get isLoading$(){return this.loadingService.getLoadingStatus()}ngOnInit(){this.routeToSidenav(),this.getResourceData()}getResourceData(){this.router.events.pipe(E(e=>e instanceof ge),f(()=>this.route),he(e=>{let r=this.route.snapshot.paramMap.get("id");for(;e.firstChild;)e=e.firstChild;return this.selectedResourceDetailTabId=e.snapshot.url[0].path,this.updateResourceId(r),this.dataApiService.getResourceData(r)}),h(this._destroyed$)).subscribe({next:e=>{this.resourceData=e},error:e=>this.errorMessage=e})}onResourceDetailTabChange(e){let t=e.nextId;this.router.navigate([t],{relativeTo:this.route})}updateResourceId(e){this.resourceId=e,this.dataStreamerService.updateResourceId(e)}navigateToResource(e){let t=e??this.oldId??this.resourceId;this.oldId=this.resourceId,this.router.navigate(["/data/resource",+t])}exposeGnd(e){e&&this.gndService.exposeGnd(e)}routeToSidenav(){this.router.navigate([{outlets:{side:"resourceInfo"}}],{preserveFragment:!0,queryParamsHandling:"preserve"})}ngOnDestroy(){this._destroyed$.next(!0),this._destroyed$.complete()}},H.ctorParameters=()=>[{type:D},{type:_},{type:w},{type:O},{type:Xe},{type:Se}],H);R=o([s({selector:"awg-resource-detail",template:It,changeDetection:i.Default,styles:[Et]})],R);var Pt=`@if (searchRouterLinkButtons) {
...
<router-outlet />
`;var Dt="";var Q,ce=(Q=class{constructor(e,t){this.sideInfoService=e,this.route=t}ngOnInit(){this.setButtons(),this.updateSearchInfoTitleFromPath()}setButtons(){this.searchRouterLinkButtons=[new Z("/data","search","Suche",!1),new Z("/data","timeline","Timeline",!0),new Z("/data","bibliography","Bibliographie",!0)]}updateSearchInfoTitleFromPath(){let e=this.route.snapshot.url[0].path,t=this.searchRouterLinkButtons.filter(r=>r.link===e);t.length===1&&this.sideInfoService.updateSearchInfoTitle(t[0].label)}onButtonSelect(e){let t=e instanceof Z;!e||!t||!e.label||(this.sideInfoService.clearSearchInfoData(),this.sideInfoService.updateSearchInfoTitle(e.label))}},Q.ctorParameters=()=>[{type:_e},{type:D}],Q);ce=o([s({selector:"awg-search-overview",template:Pt,styles:[Dt]})],ce);var At=`<!-- content: search panel -->
...
<!-- search results -->
`;var Lt="";var Y,I=(Y=class{constructor(e,t,r,a,u,J){this.route=e,this.router=t,this.conversionService=r,this.dataApiService=a,this.dataStreamerService=u,this.loadingService=J,this.errorMessage=void 0,this.searchTabs={fulltext:{id:"fulltext",title:"Volltext-Suche"},extended:{id:"extended",title:"Erweiterte Suche"}},this.viewChanged=!1,this._destroyed$=new g}get httpGetUrl(){return this.dataApiService.httpGetUrl}get isLoading$(){return this.loadingService.getLoadingStatus()}ngOnInit(){this.resetSearchParams(),this.getSearchData()}getSearchData(){this.router.events.pipe(E(e=>e instanceof ge),f(()=>this.route),f(e=>{let t=e;for(;t.firstChild;)t=t.firstChild;return this._isValidTabIdInRoute(t)&&(this.selectedSearchTabId=t.snapshot.url[0].path),e}),he(e=>{let t=e.snapshot.queryParamMap;if(t!==this.currentQueryParams){if(this.currentQueryParams=t,t.keys.length<4)this.updateSearchParamsFromRoute(t,!0);else if(this.updateSearchParamsFromRoute(t,!1),!this.viewChanged){if(this.searchParams.query&&typeof this.searchParams.query=="string")return this.dataApiService.getSearchData(this.searchParams);if(typeof this.searchParams.query=="object"&&this.searchParams.query.filterByRestype)return this.dataApiService.getSearchData(this.searchParams)}}return Ue}),h(this._destroyed$)).subscribe({next:e=>{this.searchResponseWithQuery=new Oe(e,this.searchParams.query),this.dataStreamerService.updateSearchResponseWithQuery(this.searchResponseWithQuery)},error:e=>{this.errorMessage=e,console.error("SearchPanel# getSearchData subscription error: ",this.errorMessage)}})}onPageChange(e){e!==this.searchParams.startAt&&(this.viewChanged=!1,this.searchParams=new b(this.searchParams.query,this.searchParams.nRows,e,this.searchParams.viewType),this._routeToSelf(this.searchParams))}onRowNumberChange(e){e!==this.searchParams.nRows&&(this.viewChanged=!1,this.searchParams=new b(this.searchParams.query,e,"0",this.searchParams.viewType),this._routeToSelf(this.searchParams))}onSearch(e){e!==this.searchParams.query&&(this.viewChanged=!1,this.searchParams=new b(e,this.searchParams.nRows,this.searchParams.startAt,this.searchParams.viewType),this._routeToSelf(this.searchParams))}onSearchTabChange(e){let t=e.nextId;this.resetSearchParams(t),this.resetSearchResponse(),this.errorMessage=void 0,this._routeToSelf(this.searchParams,t)}onViewChange(e){e!==this.searchParams.viewType&&(this.viewChanged=!0,this.searchParams=new b(this.searchParams.query,this.searchParams.nRows,this.searchParams.startAt,e),this._routeToSelf(this.searchParams))}resetSearchParams(e){let t;!e||e===this.searchTabs.fulltext.id?t="":e===this.searchTabs.extended.id&&(t=new K,t.filterByRestype="",t.propertyId=[],t.compop=[],t.searchval=[]),this.searchParams=new b(t,"25","0",m.TABLE)}resetSearchResponse(){this.searchResponseWithQuery=new Oe(new y,""),this.dataStreamerService.updateSearchResponseWithQuery(this.searchResponseWithQuery)}updateSearchParamsFromRoute(e,t){if(!e)return;let r;!this.selectedSearchTabId||this.selectedSearchTabId===this.searchTabs.fulltext.id||typeof this.searchParams.query=="string"?r=e.get("query")||this.searchParams.query:(this.selectedSearchTabId===this.searchTabs.extended.id||typeof this.searchParams.query=="object")&&(r=new K,r.filterByRestype=e.get("filterByRestype")||this.searchParams.query.filterByRestype,r.propertyId=e.getAll("propertyId")||this.searchParams.query.propertyId,r.compop=e.getAll("compop")||this.searchParams.query.compop,r.searchval=e.getAll("searchval")||this.searchParams.query.searchval),this.searchParams=new b(r,e.get("nrows")||this.searchParams.nRows,e.get("startAt")||this.searchParams.startAt,m[e.get("view")]||this.searchParams.viewType),t&&this._routeToSelf(this.searchParams)}getSearchQueryType(e){if(typeof e=="string")return e;if(typeof e=="object")return e}isSearchResultListShown(){return this.dataStreamerService.getSearchResponseWithQuery().pipe(h(this._destroyed$)).subscribe({next:e=>console.log(e)}),!0}ngOnDestroy(){this._destroyed$.next(!0),this._destroyed$.complete()}_routeToSelf(e,t){let r=t?[t]:[],a=this._createRouterQueryParams(e);this.router.navigate(r,{relativeTo:this.route,queryParams:a})}_createRouterQueryParams(e){let t={},r=this.getSearchQueryType(e.query);return typeof r=="string"?t.query=e.query:typeof r=="object"&&(t.filterByRestype=r.filterByRestype||"",r.propertyId&&(t.propertyId=r.propertyId||[],t.compop=r.compop||[],t.searchval=r.searchval||[])),t.nrows=e.nRows,t.startAt=e.startAt,t.view=e.viewType,t}_isValidTabIdInRoute(e){return e.snapshot.url&&e.snapshot.url.length>0&&Object.values(this.searchTabs).filter(t=>t.id===e.snapshot.url[0].path).length>0}},Y.ctorParameters=()=>[{type:D},{type:_},{type:L},{type:w},{type:O},{type:Se}],Y);I=o([s({selector:"awg-search-panel",template:At,styles:[Lt]})],I);var Ot=`<!-- content: search -->
...
<!-- data (search) routes -->
<router-outlet />
`;var kt="";var W,pe=(W=class{constructor(e){this.router=e,this.searchTitle="Suche",this.searchId="search"}ngOnInit(){this.routeToSidenav()}routeToSidenav(){this.router.navigate([{outlets:{side:"searchInfo"}}],{preserveFragment:!0,queryParamsHandling:"preserve"})}},W.ctorParameters=()=>[{type:_}],W);pe=o([s({selector:"awg-data",template:Ot,styles:[kt]})],pe);var Ar=[{path:"",component:pe,children:[{path:"",pathMatch:"full",redirectTo:"search"},{path:"search",component:ce,children:[{path:"",component:I,children:[{path:"",pathMatch:"full",redirectTo:"fulltext"},{path:"fulltext",data:{title:"AWG Online Edition \u2013 Fulltext Search"},component:I},{path:"extended",data:{title:"AWG Online Edition \u2013 Extended Search"},component:I},{path:"detail/:id",redirectTo:"resource/:id"}]}]}]},{path:"resource/:id",component:R,data:{title:"AWG Online Edition \u2013 Resource Detail"},children:[{path:"",pathMatch:"full",redirectTo:"html"},{path:"html",data:{title:"AWG Online Edition \u2013 Resource Detail HTML"},component:R},{path:"converted-json",data:{title:"AWG Online Edition \u2013 Resource Detail JSON Converted"},component:R},{path:"raw-json",data:{title:"AWG Online Edition \u2013 Resource Detail JSON Raw"},component:R}]}],qt=[pe,ce,I,R],Ee=class{};Ee=o([P({imports:[De.forChild(Ar)],exports:[De]})],Ee);var Nt=class{};Nt=o([P({imports:[ve,Re,Ee],declarations:[qt,xe,Te,Ie]})],Nt);export{Nt as DataViewModule};
