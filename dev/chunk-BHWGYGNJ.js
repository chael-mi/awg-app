import{a as T}from"./chunk-I7IXUIMH.js";import{f as p}from"./chunk-FNACZB34.js";import{a as G,m as W}from"./chunk-FEI7N5PX.js";import{c as D,v as L}from"./chunk-XDTQHBQK.js";import"./chunk-DVBDYUR7.js";import{G as r,L as i,Ma as A,Oa as k,Q as F,R as n,T as c,U as o,X as v,k as O,l as s,ob as b,t as $,z as N}from"./chunk-EOZI3YUX.js";var U=`<div class="awg-source-description-corrections">
...
`;var P="";var m,x=(m=class{constructor(){this.navigateToReportFragmentRequest=new i,this.openModalRequest=new i,this.selectSvgSheetRequest=new i,this.ref=this}navigateToReportFragment(t){t&&this.navigateToReportFragmentRequest.emit(t)}openModal(t){t&&this.openModalRequest.emit(t)}selectSvgSheet(t){t?.sheetId&&this.selectSvgSheetRequest.emit(t)}},m.ctorParameters=()=>[],m.propDecorators={corrections:[{type:c}],navigateToReportFragmentRequest:[{type:o}],openModalRequest:[{type:o}],selectSvgSheetRequest:[{type:o}]},m);x=s([n({selector:"awg-source-description-corrections",template:U,changeDetection:r.OnPush,styles:[P]})],x);var j=`@if (sourceDescriptionListData) {
