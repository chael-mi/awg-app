import{a as M}from"./chunk-AG7DNQEP.js";import{f as p}from"./chunk-XWCIOFN6.js";import{a as U,m as P}from"./chunk-SFUMQK4L.js";import{c as T,v as W}from"./chunk-GMKCI3L3.js";import"./chunk-S7GD3LSL.js";import{G as r,L as t,Ma as G,Oa as F,Q as A,R as a,T as n,U as i,X as R,k as O,l as o,ob as D,t as L,z as N}from"./chunk-4DUUYM7V.js";var j=`<div class="awg-source-description-corrections">
...
`;var f,$=(f=class{constructor(e){this.utils=e,this.navigateToReportFragmentRequest=new t,this.openModalRequest=new t,this.ref=this}navigateToReportFragment(e){e?.fragmentId&&this.navigateToReportFragmentRequest.emit(e)}openModal(e){e&&this.openModalRequest.emit(e)}},f.ctorParameters=()=>[{type:p}],f.propDecorators={sourceListData:[{type:n}],navigateToReportFragmentRequest:[{type:i}],openModalRequest:[{type:i}]},f);$=o([a({selector:"awg-source-list",template:Y,changeDetection:r.OnPush,styles:[J]})],$);var X=`@if (textcriticsData) {
    <div ngbAccordion>
...
`;var ee="";var v,C=(v=class{constructor(e){this.utils=e,this.navigateToReportFragmentRequest=new t,this.openModalRequest=new t,this.selectSvgSheetRequest=new t,this.ref=this}navigateToReportFragment(e){e?.fragmentId&&this.navigateToReportFragmentRequest.emit(e)}openModal(e){e&&this.openModalRequest.emit(e)}selectSvgSheet(e){e?.sheetId&&this.selectSvgSheetRequest.emit(e)}},v.ctorParameters=()=>[{type:p}],v.propDecorators={textcriticsData:[{type:n}],navigateToReportFragmentRequest:[{type:i}],openModalRequest:[{type:i}],selectSvgSheetRequest:[{type:i}]},v);C=o([a({selector:"awg-textcritics-list",template:X,changeDetection:r.OnPush,styles:[ee]})],C);var te=`<!-- content: edition report -->
<div>
    <!-- modal -->
...
`;var ie="";var h,y=(h=class{constructor(e,s,c){this.editionDataService=e,this.editionService=s,this.router=c,this.errorObject=null,this.titles={sourceList:"1. Quellen\xFCbersicht",sourceDescription:"2. Quellenbeschreibung",sourceEvaluation:"3. Quellenbewertung",tka:"4. Textkritische Anmerkungen"}}get editionRouteConstants(){return T}ngOnInit(){this.getEditionReportData()}getEditionReportData(){this.editionReportData$=this.editionService.getEditionComplex().pipe(N(e=>(this.editionComplex=e,this.editionDataService.getEditionReportData(this.editionComplex))),L(e=>(this.errorObject=e,O)))}onModalOpen(e){e&&this.modal.open(e)}onReportFragmentNavigate(e){let s=this.editionRouteConstants.EDITION_REPORT.route,c={fragment:e?.fragmentId??""};this._navigateWithComplexId(e?.complexId,s,c)}onSvgSheetSelect(e){let s=this.editionRouteConstants.EDITION_SHEETS.route,c={queryParams:{id:e?.sheetId??""}};this._navigateWithComplexId(e?.complexId,s,c)}_navigateWithComplexId(e,s,c){let S=e?`/edition/complex/${e}/`:this.editionComplex.baseRoute;this.router.navigate([S,s],c)}},h.ctorParameters=()=>[{type:U},{type:P},{type:G}],h.propDecorators={modal:[{type:A,args:["modal",{static:!0}]}]},h);y=o([a({selector:"awg-edition-report",template:te,changeDetection:r.OnPush,styles:[ie]})],y);var Se=[{path:"",component:y,data:{title:"AWG Online Edition \u2013 Report"}}],oe=[y],I=class{};I=o([R({imports:[F.forChild(Se)],exports:[F]})],I);var se=class{};se=o([R({imports:[D,M,E,I],declarations:[C,q,$,oe]})],se);export{se as EditionReportModule};
